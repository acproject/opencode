export namespace Flag {
  ...
  export const OPENCODE_EXPERIMENTAL_LANGCHAIN_TOOL_RUNTIME =
    OPENCODE_EXPERIMENTAL || truthy("OPENCODE_EXPERIMENTAL_LANGCHAIN_TOOL_RUNTIME")
  export const OPENCODE_EXPERIMENTAL_LANGCHAIN_ORCHESTRATOR =
    OPENCODE_EXPERIMENTAL || truthy("OPENCODE_EXPERIMENTAL_LANGCHAIN_ORCHESTRATOR")
